   ...
   <div class="col-lg-6">
                                                    ...
                                                    <div class="col-lg-6">
                                                        <div class="mb-3">
                                                            ...
                                                            <input type="text" class="form-control" id="firstnameInput" name="fa" placeholder="ex. fa-facebook-icon">
                                                        </div>
                                                    </div>
                                                    ...
                                                    <div class="col-lg-6">
                                                        <div class="mb-3">
                                                            ...
                                                            <input type="text" class="form-control" id="firstnameInput" name="social_link" placeholder="ex. https://facebook.com/">
                                                        </div>
                                                    </div>
