                            ...
                            <div class="page-title-box d-sm-flex align-items-center justify-content-between">
                                ...
                                <div class="page-title-right">
                                    <ol class="breadcrumb m-0">
                                        ...
                                        <li class="breadcrumb-item active">Add Potfolio</li>
                                    </ol>
                                </div>
   ...
   <div class="col-lg-6">
                                                    ...
                                                    <div class="col-lg-6">
                                                        <div class="mb-3">
                                                            ...
                                                            <textarea class="form-control" id="exampleFormControlTextarea5" name="port_desc" placeholder="Enter Description" rows="2"></textarea>
                                                        </div>
                                                    </div>
                                                    ...
                                                    <div class="col-lg-6">
                                                        <div class="mb-3">
                                                            ...
                                                            <textarea class="form-control" id="exampleFormControlTextarea5" name="port_detail" placeholder="Enter Portfolio Detail" rows="3"></textarea>
                                                        </div>
                                                    </div>
