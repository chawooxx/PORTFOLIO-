                            ...
                            <div class="page-title-box d-sm-flex align-items-center justify-content-between">
                                ...
                                <div class="page-title-right">
                                    <ol class="breadcrumb m-0">
                                        ...
                                        <li class="breadcrumb-item active">Section Titles</li>
                                    </ol>
                                </div>
...
$skills_text = mysqli_real_escape_string($con,$_POST['skills_text']);
...
$educ_title = mysqli_real_escape_string($con,$_POST['educ_title']);
$educ_text = mysqli_real_escape_string($con,$_POST['educ_text']);
...
if($status=="OK")
{
$qb=mysqli_query($con,"update section_title set about_title='$about_title', about_text='$about_text', skills_title='$skills_title',skills_text='$skills_text',service_title='$service_title',service_text='$service_text',port_title='$port_title',port_text='$port_text',educ_title='$educ_title',educ_text='$educ_text',contact_title='$contact_title',contact_text='$contact_text',enquiry_title='$enquiry_title',enquiry_text='$enquiry_text' where id=1");
...
$educ_title="$row[educ_title]";
$educ_text="$row[educ_text]";
...
if($_SERVER['REQUEST_METHOD'] == 'POST')
   ...
   <div class="col-lg-6">
                                                    ...
                                                    <div class="col-lg-6">
                                                        <div class="mb-3">
                                                            <label for="firstnameInput" class="form-label"> Skill Title</label>
                                                            <input type="text" class="form-control" id="firstnameInput" name="skills_title"  value="<?php print $skills_title ?>">
                                                        </div>
                                                    </div>

                                                    <div class="col-lg-6">
                                                        <div class="mb-3">
                                                            <label for="firstnameInput" class="form-label"> Skill Text</label>
                                                            <textarea class="form-control" id="exampleFormControlTextarea5" name="skills_text" rows="2"><?php print $skills_text ?></textarea>
                                                        </div>
                                                    </div>
                                                    ...
                                                    <div class="col-lg-6">
                                                        <div class="mb-3">
                                                            <label for="firstnameInput" class="form-label"> Eduacation Title</label>
                                                            <input type="text" class="form-control" id="firstnameInput" name="educ_title"  value="<?php print $educ_title ?>">
                                                        </div>
                                                    </div>

                                                    <div class="col-lg-6">
                                                        <div class="mb-3">
                                                            <label for="firstnameInput" class="form-label"> Eduacation Text</label>
                                                            <textarea class="form-control" id="exampleFormControlTextarea5" name="educ_text" rows="2"><?php print $educ_text ?></textarea>
                                                        </div>
                                                    </div>

                                                    <div class="col-lg-6">
                                                        <div class="mb-3">
                                                            <label for="firstnameInput" class="form-label"> Contact Title</label>
                                                    ...
                                                    <div class="col-lg-6">
                                                        <div class="mb-3">
                                                            <label for="firstnameInput" class="form-label"> Contact Text</label>
