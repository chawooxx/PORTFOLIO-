! function() {
	...
	function L() {
		feather.replace();
		var e, t, a = "/" == location.pathname ? "dashboard.php" : location.pathname.substring(1);
	...
	function A() {
		var e = "/" == location.pathname ? "dashboard.php" : location.pathname.substring(1);
