                    ...
                    <div class="row">
                        <div class="col-12">
                            <div class="page-title-box d-sm-flex align-items-center justify-content-between">
                                <h4 class="mb-sm-0">Static Home</h4>
...
$stext = mysqli_real_escape_string($con,$_POST['stext']);
 ...
 if ( strlen($stitle) < 5 ){
$msg=$msg."Home Title field can not be empty.<BR>";
$status= "NOTOK";}
 if ( strlen($stext) < 20 ){
$msg=$msg."Home Description Field Must contain characters.<BR>";
$status= "NOTOK";}
...
<div class='alert alert-success alert-dismissible alert-outline fade show'>
                Home Info Updated successfully.
   ...
   ?>
              <form action="" method="post" enctype="multipart/form-data">
                                                <div class="row">
                                                    ...
                                                    <div class="col-lg-6">
                                                        <div class="mb-3">
                                                            <label for="firstnameInput" class="form-label">Home Decription</label>
