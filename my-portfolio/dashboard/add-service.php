   ...
   <div class="col-lg-6">
                                                    ...
                                                    <div class="col-lg-6">
                                                        <div class="mb-3">
                                                            ...
                                                            <textarea class="form-control" id="exampleFormControlTextarea5" name="service_desc" placeholder="Enter Description" rows="2"></textarea>
                                                        </div>
                                                    </div>
                                                    ...
                                                    <div class="col-lg-6">
                                                        <div class="mb-3">
                                                            ...
                                                            <textarea class="form-control" id="exampleFormControlTextarea5" name="service_detail" placeholder="Enter Service Details" rows="3"></textarea>
                                                        </div>
                                                    </div>
