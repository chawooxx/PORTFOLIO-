                    ...
                    <div class="row">
                        <div class="col-12">
                            <div class="page-title-box d-sm-flex align-items-center justify-content-between">
                                <h4 class="mb-sm-0">Site Configuration</h4>
...
if($_SERVER['REQUEST_METHOD'] == 'POST')
   ...
   <div class="col-lg-6">
                                                        <div class="mb-3">
                                                            ...
                                                            <input type="text" class="form-control" id="firstnameInput" name="site_title" placeholder="Enter Site Title"  value="<?php print $site_title ?>">
                                                        </div>
                                                    </div>
                                                    ...
                                                    <div class="col-lg-6">
                                                        <div class="mb-3">
                                                            ...
                                                            <input type="text" class="form-control" id="firstnameInput" name="site_keyword" placeholder="Enter Site Keywords"  value="<?php print $site_keyword ?>">
                                                        </div>
                                                    </div>
                                                    ...
                                                    <div class="col-lg-6">
                                                        <div class="mb-3">
                                                            ...
                                                            <input type="text" class="form-control" id="firstnameInput" name="site_footer" placeholder="Enter Footer Text"  value="<?php print $site_footer ?>">
                                                        </div>
                                                    </div>
                                                    ...
                                                    <div class="col-lg-6">
                                                        <div class="mb-3">
                                                            ...
                                                            <textarea class="form-control" id="exampleFormControlTextarea5" name="follow_text" rows="3" placeholder="Enter Social Follow Text"><?php print $follow_text ?></textarea>
                                                        </div>
                                                    </div>
